...
class RoostooClient:
    """Minimal Roostoo REST client for the live bot."""
        ...
        for attempt in range(self.max_retries):
            try:
                ...
                if not isinstance(payload, dict):
                    raise RuntimeError(f"Unexpected Roostoo response payload: {payload!r}")
                return payload
    ...
    def get_server_time(self) -> Dict[str, Any]:
        return self._request_json("GET", f"{self.base_url}/v3/serverTime")

    def get_exchange_info(self) -> Dict[str, Any]:
        return self._request_json("GET", f"{self.base_url}/v3/exchangeInfo")

    def get_ticker(self, pair: Optional[str] = None) -> Dict[str, Any]:
        params: Dict[str, Any] = {"timestamp": self._timestamp_ms()}
        if pair:
            params["pair"] = pair
        return self._request_json("GET", f"{self.base_url}/v3/ticker", params=params)
    ...
    def get_balance(self) -> Dict[str, Any]:
        ...
        return self._request_json("GET", f"{self.base_url}/v3/balance", headers=headers, params=params)

    def get_pending_count(self) -> Dict[str, Any]:
        params = {"timestamp": self._timestamp_ms()}
        total_params = self._serialize_params(params)
        headers = self._signed_headers(total_params, is_post=False)
        return self._request_json("GET", f"{self.base_url}/v3/pending_count", headers=headers, params=params)
    ...
    def place_order(
        ...
        *,
        ...
        return self._request_json("POST", f"{self.base_url}/v3/place_order", headers=headers, data=total_params)
    ...
    def query_order(
        ...
        *,
        ...
        total_params = self._serialize_params(payload)
        headers = self._signed_headers(total_params, is_post=True)
        return self._request_json("POST", f"{self.base_url}/v3/query_order", headers=headers, data=total_params)
    ...
    def cancel_order(
        ...
        *,
        ...
        if order_id is not None and pair is not None:
            raise ValueError("Only one of order_id and pair may be sent to cancel_order.")
        ...
        total_params = self._serialize_params(payload)
        headers = self._signed_headers(total_params, is_post=True)
        return self._request_json("POST", f"{self.base_url}/v3/cancel_order", headers=headers, data=total_params)

    def get_trade_pair_rules(
        self,
        pair: str,
        *,
